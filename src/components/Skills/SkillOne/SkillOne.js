                    ...
                    <div className="col-lg-6 col-md-6">
                        ...
                        <div className="skill-content">
                            ...
                            <h3 className="sec-title">
                                Taxation and management Solutions
                                For Business
	                        </h3>
                            <p className="sec-desc">
                            We are the real tax professionals!
As Enrolled Agents, we admitted practicing in all 50 states through the Department of the Treasury Internal Revenue Service(IRS). We are Tax Strategists, offering Quality Tax & Bookkeeping Solutions!.
	                        </p>
