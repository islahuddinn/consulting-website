...
const services = [
    {
        id: 1,
        title: "Cryptocurency Taxation",
        link: '#',
        description: 'We understand how the IRS works and what it takes to successfully mediate a solution on your behalf​ We know what the IRS can and can not do to collect delinquent taxes from the taxpayer We position the taxpayer the best possible situation for addressing their tax liability Our service fee is affordable and flat, with no hidden fee and dark magic',
        icon: 'fa-plus'
    },
    {
        id: 2,
        title: "Tax Filing",
        link: '#',
        description: 'We provide comprehensive tax planning and preparation, maximize your tax refunds, avoid mistakes, save time & money, mitigate stress. 1.Small Business Owners, we offer! 2.Sales Tax Filing 3.Payroll Tax Preparation 4.Estimated Tax Preparation 5.Unemployment Taxes Preparation 6.Handling Back Taxes & Amended Taxes 7.Partnership & Corporate Tax Preparation 8. Federal, State and Local taxes Preparation',
        icon: 'fa-plus'
    }, {
        id: 3,
        title: "ITIN Application",
        link: '#',
        description: 'We are team of professionals. we help you to get ITIN number and register LLC with deep dive ITIN Aplication. We are the team of experts and we know the clue of best filling.',
        icon: 'fa-plus'
    }, {
        id: 4,
        title: "Bookeeping",
        link: '#',
        description: 'With our bookkeeping strategy, you can keep your business organized, creating and tracking financial benchmarks, limiting tax burden, and boosting production',
        icon: 'fa-plus'
    }, {
        id: 5,
        title: "Tax Resolution",
        link: '#',
        description: 'Why Choose Us For Tax Resolution! We are real people that care! We care for our clients, with straight talk and real answers, we do our best to find the best solution to address your tax problem. As Enrolled Agents, we admitted practicing in all 50 states through the IRS. We are proud members of the NAEA and ASTPS. We serve our local community for years, also present cases nationwide.We understand how the IRS works and what it takes to successfully mediate a solution on your behalf.',
        icon: 'fa-plus'
    }, {
        id: 6,
        title: "Payroll Services",
        link: '#',
        description: 'We offer the best in legal compliance and accountability, provide you efficient, reliable payroll services while minimizing tax liability concerns. So you save time, save money,  and stressless. We offer: 1. Quarterly Tax Forms filing. 2. Year-End Tax Forms filing. 3. State unemployment tax preparation. 4. Filing W2s, W3s, 1099s, 1096s, and other miscellaneous tax forms if need it. 5. Paychecks Processing 6. Federal tax deposit preparation.  7. Deliver Payroll Reports. 8. Ensuring accurate payroll tax and deductions',
        icon: 'fa-plus'
    },{
        id: 7,
        title: "QuickBook Accounting",
        link: '#',
        description: 'Our team of QuickBooks Certified ProAdvisors has experience working with companies in many industries with an efficient Quickbooks system. Services! 1. QuickBooks setup services 2. Tracking of billable hours 3. Handling retainers 4. Setting up reports to track income and expenses 5. Availability to answer questions via phone or email 6. Help troubleshooting QuickBooks problems 7. QuickBooks training sessions for your employees 8. Bookkeeping and accounting services 9. Year-end accounting',
        icon: 'fa-plus'
    }
];
