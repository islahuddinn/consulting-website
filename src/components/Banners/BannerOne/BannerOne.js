                ...
                <div className="row">
                    <div className="col-lg-7 col-md-10">
                        <div className="banner-content">
                            ...
                            <h1>Get Solutions</h1>
                            <p>
                            We help our clients to reduce tax liability by 5-35%, slash business expenses, stimulate cash flow, and navigate 
                            the best financial resource with tax reduction strategies and planning. So they can achieve profitable long-term growth.
                            </p>
