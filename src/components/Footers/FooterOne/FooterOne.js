                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <aside className="widget">
                            ...
                            <ul>
                                <li><Link to="/">Cryptocurency Taxation</Link></li>
                                <li><Link to="/">Tax Filing</Link></li>
                                <li><Link to="/">Bookkeeping</Link></li>
                                <li><Link to="/">CFO Services</Link></li>
                                <li><Link to="/">ITIN Application</Link></li>
                                <li><Link to="/">Quickbooks Accounting</Link></li>
                                <li><Link to="/">Payroll Services</Link></li>
                                <li><Link to="/">Tax Resolution</Link></li>
                            </ul>
                        </aside>
                        {/* <!-- Navigation Menu End --> */}
                    </div>
                    <div className="col-lg-3 col-md-6">
                        ...
                        <aside className="widget">
                            ...
                            <ul>
                                ...
                                <li><Link to="/contact">Trouble Signing In?</Link></li>
                                <li><Link to="/contact">Book Cunsuting</Link></li>
                                <li><Link to="/contact">Report Abuse</Link></li>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="copyright clearfix">
                            <ul>
                                <li><Link to="/https://web.facebook.com/barakatax999"><i className="fa fa-facebook-f"></i></Link></li>
                                <li><Link to="/https://www.instagram.com/barakataxservices/"><i className="fa fa-instagram"></i></Link></li>
                                <li><Link to="/"><i className="fa fa-behance"></i></Link></li>
                                <li><Link to="/"><i className="fa fa-youtube"></i></Link></li>
                                <li><Link to="/https://www.linkedin.com/in/seamira-lip-9896aa1a5/"><i className="fa fa-linkedin"></i></Link></li>
                            </ul>
                            <p>2023 BarakaTax & Bookkeeping LLC</p>
                        </div>
                    </div>
                </div>
                {/* <!-- Copryright --> */}
